...
public class AddEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(addEdit.equals("add")){
            ...
            name.getEditText().setText(DummyDate.contacts.get(position).getName());
            phone.getEditText().setText(DummyDate.contacts.get(position).getPhone());
            email.getEditText().setText(DummyDate.contacts.get(position).getEmail());
        }
    }
        ...
        switch (item.getItemId()){
            ...
            case R.id.menu_save:
                ...
                if(!inputName.trim().equals("") && !inputPhone.trim().equals("")){
                    ...
                    DummyDate.contacts.add(newContact);
                    finish();
                }
                } else if(addEdit.equals("edit")){
                    Contact editContact = DummyDate.contacts.get(position);
